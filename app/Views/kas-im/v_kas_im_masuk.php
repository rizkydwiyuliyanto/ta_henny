<div class="col-md-12">
    ...
    <div class="alert alert-success alert-dismissible">
        <h5><i class="fas fa-money-bill-wave"></i></i> Total Pemasukan Kas Ibadah Mingguan</h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('KasIm/InsertKasMasuk') ?>
    ...
    <div class="modal fade" id="modal-edit<?= $value['id_kas_im'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open('KasIm/UpdateKasMasuk/' . $value['id_kas_im']) ?>
                    <div class="form-group">
                        <label for="">Tanggal</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="<?= base_url('KasIm/DeleteKasMasuk/' . $value['id_kas_im']) ?>" class="btn btn-danger">Ya</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
