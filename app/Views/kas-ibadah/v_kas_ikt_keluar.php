<div class="col-md-12">
    ...
    <div class="alert alert-danger alert-dismissible">
        <h5><i class="fas fa-money-bill-wave"></i> Total Pengeluaran Kas Ikt</h5>
                ...
                <tbody>
                    ...
                    foreach ($kas as $key => $value) { ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#modal-edit<?= $value['id_kas_ibadah'] ?>"><i class="fas fa-pencil-alt"></i>
                                </button>
                                <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modal-delete<?= $value['id_kas_ibadah'] ?>"><i class="fas fa-trash"></i>
                                </button>
                            </td>
                        </tr>
                    <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('KasIbadah/InsertKasKeluar') ?>
...
<?php foreach ($kas as $key => $value) { ?>
    <!-- /.modal-edit -->
    <div class="modal fade" id="modal-edit<?= $value['id_kas_ibadah'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open('KasIbadah/UpdateKasKeluar/' . $value['id_kas_ibadah']) ?>
                    <div class="form-group">
                        <label for="">Tanggal</label>
...
<?php foreach ($kas as $key => $value) { ?>
    <!-- /.modal-edit -->
    <div class="modal fade" id="modal-delete<?= $value['id_kas_ibadah'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header  bg-success">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="<?= base_url('KasIbadah/DeleteKasKeluar/' . $value['id_kas_ibadah']) ?>" class="btn btn-danger">Ya</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
