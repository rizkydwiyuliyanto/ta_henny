<div class="col-md-12">
    ...
    <div class="alert alert-success alert-dismissible">
        <h5><i class="fas fa-money-bill-wave"></i></i> Total Pemasukan Kas Ikt</h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('KasIbadah/InsertKasMasuk') ?>
    ...
    <div class="modal fade" id="modal-edit<?= $value['id_kas_ibadah'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open('KasIbadah/UpdateKasMasuk/' . $value['id_kas_ibadah']) ?>
                    <div class="form-group">
                        <label for="">Tanggal</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="<?= base_url('KasIbadah/DeleteKasMasuk/' . $value['id_kas_ibadah']) ?>" class="btn btn-danger">Ya</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
