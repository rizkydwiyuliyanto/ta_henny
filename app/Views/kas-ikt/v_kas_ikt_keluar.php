<div class="col-md-12">
    ...
    <div class="alert alert-danger alert-dismissible">
        <h5><i class="fas fa-money-bill-wave"></i> Total Pengeluaran Kas Rumah Tongkonan</h5>
                ...
                <tbody>
                    ...
                    foreach ($kas as $key => $value) { ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#modal-edit<?= $value['id_kas_ikt'] ?>"><i class="fas fa-pencil-alt"></i>
                                </button>
                                <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modal-delete<?= $value['id_kas_ikt'] ?>"><i class="fas fa-trash"></i>
                                </button>
                            </td>
                        </tr>
                    <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('KasIkt/InsertKasKeluar') ?>
...
<?php foreach ($kas as $key => $value) { ?>
    <!-- /.modal-edit -->
    <div class="modal fade" id="modal-edit<?= $value['id_kas_ikt'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open('KasIkt/UpdateKasKeluar/' . $value['id_kas_ikt']) ?>
                    <div class="form-group">
                        <label for="">Tanggal</label>
...
<?php foreach ($kas as $key => $value) { ?>
    <!-- /.modal-edit -->
    <div class="modal fade" id="modal-delete<?= $value['id_kas_ikt'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header  bg-success">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="<?= base_url('KasIkt/DeleteKasKeluar/' . $value['id_kas_ikt']) ?>" class="btn btn-danger">Ya</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
