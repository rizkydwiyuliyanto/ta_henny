    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-8">
                ...
                <div class="mb-5">
                    <center>
                        <img class="img-fluid w-50 rounded mb-5" src="<?= base_url('fotokegiatan/' . $agenda['foto_kegiatan']) ?>" width="80px" height="10px">
                    </center>
                    <h1 class="mb-4"><?= $agenda['nama_kegiatan'] ?></h1>
                    <p><?= $agenda['isi_kegiatan'] ?></p>
                </div>
                <!-- Blog Detail End -->
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                    ...
                    <?php foreach ($agendabaru as $key => $ab) { ?>
                        <div class="d-flex rounded overflow-hidden mb-3">
                            <img class="img-fluid" src="<?= base_url('fotokegiatan/' . $ab['foto_kegiatan']) ?>" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                            <a href="<?= base_url('Home/ViewAgenda/' . $ab['slug_kegiatan']) ?>" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0"><?= $ab['nama_kegiatan'] ?>
                            </a>
                        </div>
                    <?php } ?>
                </div>
